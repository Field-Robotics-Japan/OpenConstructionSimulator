// GENERATED AUTOMATICALLY FROM 'Assets/OcsSystem/InputSettings/SystemInput.inputactions'
...
namespace Ocs.Input
{
    public class @SystemInput : IInputActionCollection, IDisposable
    {
    ...
    ""controlSchemes"": [
        ...
        {
            private @SystemInput m_Wrapper;
            public GameManagerActions(@SystemInput wrapper) { m_Wrapper = wrapper; }
